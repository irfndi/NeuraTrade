...
| **5** | **Fee split:** maker×2+cross on target, maker+taker+cross on stop, entry-fee timing, `HONEST_MAKER_FEE_BP`/`HONEST_TAKER_EXIT_BP` wiring, taker-rate decision recorded. | 4 |
