...
| Parity examples | 9/9 GREEN | paper_engine_check (fees=242113 net=-1748112), grid_parity (long 0u / short 2525u), rung_parity_probe, engine_vs_ts_probe, sleeves_check, pump_catch — all exit 0; fmt+clippy `-D warnings` clean |
